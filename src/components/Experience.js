    ...
    <div className='my-64'>
      ...
      <div ref={ref} className='w-[75%] mx-auto relative lg:w-[90%] md:w-full'>
        ...
        <ul className='w-full flex flex-col items-center justify-between ml-4 xs:ml-2'>
          <Details time={"October 2023 - Deceber 2023"} position={"ReactJS Developer Intern"}
            work={<ul>
              <li>Enhance, maintain and build frontend for Website</li>
              <li>Maintain high-quality standards for the work undertaken and be</li>
              <li>Responsible for the quality of deliverables</li>
              <li>Collaborated with cross-functional teams to gather requirements, and deliver high-quality code.</li>
              <li> Ensure scalable architecture for seamless operation and high performance of the website</li>
