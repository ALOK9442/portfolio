          ...
          <div className="flex items-center justify-between w-full lg:flex-col">
            ...
            <div className="w-1/2 flex flex-col items-center self-center lg:w-full lg:text-center">
              ...
              <p className="my-4 text-base  font-medium md:text-sm sm:text-xs">
                ...
                JavaScript, React.js, Next.js and Tailwindcss. My
                focus on user experience ensures that every website I
              ...
              <div className="flex items-center self-start mt-2 lg:self-center gap-3">
                <Link href="/Alok_Resume.pdf" target={"_blank"} download={true}><Button1 name="Resume" /></Link>
                <Link href="https://www.linkedin.com/in/alok-yadav-809904237/" target={"_blank"}><Button2 name="Contact"/></Link>
              </div>
            </div>
          </div>
        </Layout>
