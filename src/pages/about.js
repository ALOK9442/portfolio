...
const about = () => {
  return (
    <>
      <Head>
        <title>Alok | About Page</title>
        <meta name="description" content="about us page alok Yadav" />
      </Head>
      <Transitioneffects/>
          ...
          <div className="grid w-full grid-cols-8 gap-16 sm:gap-8">
            <div className="col-span-3 flex flex-col items-start justify-start xl:col-span-4  md:order-2 md:col-span-8">
              ...
              <p className="font-medium">
                Hi there, I&apos;m Alok Yadav, a web developer
              ...
              <p className="font-medium my-4">
                ...
                website, or other digital product, I bring a
            ...
            <div className="col-span-3 xl:col-span-4 md:col-span-8 relative h-max rounded-2xl md:order-1 border-2 border-solid border-dark bg-light dark:bg-dark dark:border-light p-8">
              ...
              sizes="(max-width:768px) 100vw, (max-width:1200px)50vw, 33vw" alt="alok" className="w-full h-auto rounded-2xl" />
