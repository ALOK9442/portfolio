...
import cryptBEE from '../../public/images/Projects/cryptbee.png'
import Blogapp from '../../public/images/Projects/blogit.png'
import acadhub from '../../public/images/Projects/acadhub.png'
...
const projects = () => {
  ...
  return (
   <>
    <Head>
       <title>Alok | Projects Page</title>
       <meta name='description' content='web developer, Alok, Projects page' />
    </Head>
    <Transitioneffects/>
    <main className='w-full mb-16 flex flex-col items-center justify-center dark:text-light'>
     <Layout className='pt-16'>
        ...
        <div className='col-span-12'>
          <FeaturedProject type={"Featured Project-1"} link="https://cryptbee.alokyadav.tech/" title="CryptBeeWebApp" summary="cryptBEE is an innovative real-time cryptocurrency trading app that utilizes React js for the frontend and Django for the backend." github="https://github.com/ALOK9442/cryptbeeWeb"
         img={cryptBEE} />
        </div>

          <div className='col-span-6 sm:col-span-12'>
          <Project type={"Project-1"} img={Blogapp} link="https://blog-it-jet.vercel.app/" title="React js Blog Web app using Tailwindcss" github="https://github.com/ALOK9442/BlogIt"/>
          </div>
          <div className='col-span-6 sm:col-span-12'>
          <Project type={"Project-2"} link="https://github.com/ALOK9442/portfolio" img={acadhub} title="Freelance work for Acadhub using HTML CSS JS" github="https://github.com/ALOK9442/portfolio"/>
          </div>
